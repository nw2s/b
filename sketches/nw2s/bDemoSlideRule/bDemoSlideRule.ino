...
void setup() 
{
	...
	/* 16x16 Grids */
	grid = SlideRuleGrid::create(DEVICE_GRIDS, 16, 16, DIV_SIXTEENTH, DUE_OUT_D14, DUE_SPI_4822_14, DUE_OUT_D15, DUE_SPI_4822_15, DUE_OUT_D12, DUE_SPI_4822_12, DUE_OUT_D13, DUE_SPI_4822_13);
